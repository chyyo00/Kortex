...
/**
 * Registers permissions with Bukkit's live [org.bukkit.plugin.PluginManager] registry so
 * `plugin.yml` never needs a `permissions:` section. Tracks exactly which permission names this
 * instance itself added, so [unregister]/shutdown never touches a permission another plugin (or
 * another Kordex instance) already owns.
 */
class BukkitPermissionRegistrar : PermissionPlatform {
