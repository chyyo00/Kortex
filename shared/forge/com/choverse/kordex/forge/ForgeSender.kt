...
open class ForgeSender(protected val source: CommandSourceStack) : KordexSender {
    ...
    /**
     * Vanilla Minecraft/Forge has no string-keyed permission nodes - only the fixed command
